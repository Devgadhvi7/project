<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="wifi_camera.aspx.cs" Inherits="wifi_camera" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:DataList ID="DataList1" runat="server"  RepeatColumns="3" CellPadding="2" >
        ...
        <%--<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=desktop-9cf7rlj;Initial Catalog=croma;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="SELECT * FROM [product] WHERE category_name = 'Wificamera'"></asp:SqlDataSource>--%>
